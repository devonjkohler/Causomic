...
def generate_sn_data(replicates, temp_seed, coef):
    ...
    summarized_data = dataProcess(
        ...
        MBimpute=False, # no missing, change to true for missing
        sim_data=True)
...
# Save results
with open(f'compile/temp_results_{task_id}.pkl', 'wb') as file:
